...
5. **Критически важно:** Убедитесь, что в поле **Assign firewall-zone** (Назначить зону фаервола) выбрана зона `wan` (красного цвета). Поле имени новой сети оставьте по умолчанию (`wwan`).
